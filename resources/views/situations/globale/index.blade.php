...
@section('title', 'SITUATION GLOBALE DES MOUVEMENTS')
...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">SITUATION GLOBALE DES MOUVEMENTS DES APPELES VERS LES ENTRES DE FORMATIONS
            DU 01.09.2025 AU {{ now()->format('d.m.Y') }}
        </h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                @include('situations.globale.table')
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let table = $('#globale-table').DataTable();
    ...
    <script>
        ...
        var options = {
            ...
            title: {
                text: 'SITUATION GLOBALE DES MOUVEMENTS  ',
                offsetX: 15,
                align: 'middle',
            },
            fill: {
