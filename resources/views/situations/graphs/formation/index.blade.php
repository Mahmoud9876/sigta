...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">DONNEES DU GRAPH DE LA PHASE DE FORMATION</h1>
        <form action="{{route('graphs.formation')}}" method="get">
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                @include('situations.graphs.formation.table')
            </div>
        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#formation-table tfoot th').each( function () {
                let title = $(this).text();
